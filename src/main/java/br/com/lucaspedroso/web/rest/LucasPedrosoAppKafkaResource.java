...
@RestController
@RequestMapping("/api/lucas-pedroso-app-kafka")
public class LucasPedrosoAppKafkaResource {
    private final Logger log = LoggerFactory.getLogger(LucasPedrosoAppKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public LucasPedrosoAppKafkaResource(KafkaProperties kafkaProperties) {
